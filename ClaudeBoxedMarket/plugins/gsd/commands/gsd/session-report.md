...
<execution_context>
@/opt/claude-market/plugins/gsd/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/opt/claude-market/plugins/gsd/get-shit-done/workflows/session-report.md end-to-end.
</process>

...
<execution_context>
@/opt/claude-market/plugins/gsd/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/opt/claude-market/plugins/gsd/get-shit-done/workflows/docs-update.md end-to-end.

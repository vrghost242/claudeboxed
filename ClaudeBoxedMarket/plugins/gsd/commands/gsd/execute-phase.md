...
<execution_context>
@/opt/claude-market/plugins/gsd/get-shit-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @/opt/claude-market/plugins/gsd/get-shit-done/workflows/execute-phase.md end-to-end.

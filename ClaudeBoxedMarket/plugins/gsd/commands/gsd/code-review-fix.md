...
<execution_context>
@/opt/claude-market/plugins/gsd/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @/opt/claude-market/plugins/gsd/get-shit-done/workflows/code-review-fix.md end-to-end.

...
<execution_context>
@/opt/claude-market/plugins/gsd/get-shit-done/workflows/new-workspace.md
@/opt/claude-market/plugins/gsd/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @/opt/claude-market/plugins/gsd/get-shit-done/workflows/new-workspace.md end-to-end.

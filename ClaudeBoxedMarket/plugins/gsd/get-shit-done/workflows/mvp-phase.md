...
<required_reading>
@/opt/claude-market/plugins/gsd/get-shit-done/references/user-story-template.md
@/opt/claude-market/plugins/gsd/get-shit-done/references/spidr-splitting.md
@/opt/claude-market/plugins/gsd/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/opt/claude-market/plugins/gsd/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/opt/claude-market/plugins/gsd/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/opt/claude-market/plugins/gsd/get-shit-done/references/spidr-splitting.md`. Briefly:
